...
public static class ConfigLoader
{
    ...
    public static ReinforcementConfig Load(string path)
    {
        string json = File.ReadAllText(path);
        var cfg = JsonSerializer.Deserialize<ReinforcementConfig>(json, Options)
    ...
    public static void Save(ReinforcementConfig cfg, string path)
    {
